...
from agent_control_plane.models import AgentRecord, AgentStatus, CostRecord, SummaryStats
...
class TestAgentCRUD:
    ...
    def test_upsert_and_get(self, db_conn):
        ...
        from agent_control_plane.inventory import upsert_agent, get_agent
    ...
    def test_list_agents(self, db_conn):
        ...
        from agent_control_plane.inventory import upsert_agent, list_agents
    ...
    def test_delete_agent(self, db_conn):
        ...
        from agent_control_plane.inventory import upsert_agent, get_agent, delete_agent
...
class TestHealthLog:
    ...
    def test_log_health_check(self, db_conn):
        ...
        from agent_control_plane.inventory import log_health_check, get_health_history
        from agent_control_plane.inventory import upsert_agent
...
class TestCostRecords:
    ...
    def test_upsert_cost_record(self, db_conn):
        ...
        from agent_control_plane.inventory import upsert_cost_record, list_cost_records
        record = CostRecord(
